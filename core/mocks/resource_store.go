...
// SoftDelete provides a mock function with given fields: ctx, urn, deletedBy
func (_m *ResourceStore) SoftDelete(ctx context.Context, urn string, deletedBy string) error {
...
// ResourceStore_SoftDelete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SoftDelete'
type ResourceStore_SoftDelete_Call struct {
	*mock.Call
}
...
//   - urn string
//   - deletedBy string
func (_e *ResourceStore_Expecter) SoftDelete(ctx interface{}, urn interface{}, deletedBy interface{}) *ResourceStore_SoftDelete_Call {
	return &ResourceStore_SoftDelete_Call{Call: _e.mock.On("SoftDelete", ctx, urn, deletedBy)}
}

func (_c *ResourceStore_SoftDelete_Call) Run(run func(ctx context.Context, urn string, deletedBy string)) *ResourceStore_SoftDelete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ResourceStore_SoftDelete_Call) Return(_a0 error) *ResourceStore_SoftDelete_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResourceStore_SoftDelete_Call) RunAndReturn(run func(context.Context, string, string) error) *ResourceStore_SoftDelete_Call {
	_c.Call.Return(run)
	return _c
}
