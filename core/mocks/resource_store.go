...
// UpdateLabels provides a mock function with given fields: ctx, r, saveRevision, reason, hooks
func (_m *ResourceStore) UpdateLabels(ctx context.Context, r resource.Resource, saveRevision bool, reason string, hooks ...resource.MutationHook) error {
	_va := make([]interface{}, len(hooks))
	for _i := range hooks {
		_va[_i] = hooks[_i]
	}
...
// ResourceStore_UpdateLabels_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateLabels'
type ResourceStore_UpdateLabels_Call struct {
	*mock.Call
}
...
//   - reason string
//   - hooks ...resource.MutationHook
func (_e *ResourceStore_Expecter) UpdateLabels(ctx interface{}, r interface{}, saveRevision interface{}, reason interface{}, hooks ...interface{}) *ResourceStore_UpdateLabels_Call {
	return &ResourceStore_UpdateLabels_Call{Call: _e.mock.On("UpdateLabels",
		append([]interface{}{ctx, r, saveRevision, reason}, hooks...)...)}
}

func (_c *ResourceStore_UpdateLabels_Call) Run(run func(ctx context.Context, r resource.Resource, saveRevision bool, reason string, hooks ...resource.MutationHook)) *ResourceStore_UpdateLabels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]resource.MutationHook, len(args)-4)
		for i, a := range args[4:] {
			if a != nil {
...
func (_c *ResourceStore_UpdateLabels_Call) Return(_a0 error) *ResourceStore_UpdateLabels_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResourceStore_UpdateLabels_Call) RunAndReturn(run func(context.Context, resource.Resource, bool, string, ...resource.MutationHook) error) *ResourceStore_UpdateLabels_Call {
	_c.Call.Return(run)
	return _c
}
