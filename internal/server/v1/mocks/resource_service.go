...
// DeleteResource provides a mock function with given fields: ctx, urn, deletedBy
func (_m *ResourceService) DeleteResource(ctx context.Context, urn string, deletedBy string) error {
	ret := _m.Called(ctx, urn, deletedBy)
...
//   - urn string
//   - deletedBy string
func (_e *ResourceService_Expecter) DeleteResource(ctx interface{}, urn interface{}, deletedBy interface{}) *ResourceService_DeleteResource_Call {
	return &ResourceService_DeleteResource_Call{Call: _e.mock.On("DeleteResource", ctx, urn, deletedBy)}
}

func (_c *ResourceService_DeleteResource_Call) Run(run func(ctx context.Context, urn string, deletedBy string)) *ResourceService_DeleteResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ResourceService_DeleteResource_Call) RunAndReturn(run func(context.Context, string, string) error) *ResourceService_DeleteResource_Call {
	_c.Call.Return(run)
	return _c
}
